...
export const PAY_CAPTIONS_VERTICAL: CaptionEntry[] = [
  ...
  { text: "Payer opens the link.",           startAt: 0,   endAt: 70,  weight: 500, emphasizedWord: "link",          position: 10, fontSize: 50, variant: "violet" },
  ...
  { text: "Not our servers.",               startAt: 485, endAt: 530, weight: 700, emphasizedWord: "servers",       position: 75, fontSize: 72, variant: "emerald" },
  { text: "Works even if we shutdown.",     startAt: 530, endAt: 574, weight: 700, emphasizedWord: "shutdown",      position: 75, fontSize: 72, variant: "emerald" },
];

// 16:9: 8 captions. Hero @ same S-local 220-300 (overshoot, center).
// R20-E/P6: Emerald boundary shifted to FINALIZE=460. "Works even if we shutdown" added 530-574.
export const PAY_CAPTIONS_LANDSCAPE: CaptionEntry[] = [
  { text: "Payer opens the link.\nNo wallet setup required.", startAt: 0,   endAt: 80,  weight: 500, emphasizedWord: "link",         position: 10, fontSize: 59, variant: "violet" },
  ...
  { text: "Not our servers.",                                startAt: 485, endAt: 530, weight: 700, emphasizedWord: "servers",      position: 80, fontSize: 81, variant: "emerald" },
  { text: "Works even if we shutdown.",                      startAt: 530, endAt: 574, weight: 700, emphasizedWord: "shutdown",     position: 80, fontSize: 81, variant: "emerald" },
];
...
export const PAY_CAPTIONS_V2_LANDSCAPE: CaptionEntry[] = [
  { text: "Payer opens the link.",                         startAt: 0,   endAt: 80,  weight: 500, emphasizedWord: "link",         position: 10, fontSize: 59, variant: "violet" },
