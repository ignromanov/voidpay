...
export const SHARE_CAPTIONS_V2_VERTICAL: CaptionEntry[] = [
  { text: "One link. Self-contained.",              startAt: 0,   endAt: 70,  weight: 700, emphasizedWord: "link",    position: 83, fontSize: 72 },
  { text: "The hash never leaves the browser.",     startAt: 80,  endAt: 145, weight: 700, emphasizedWord: "hash",    position: 83, fontSize: 72 },
  { text: "No expiry. No permission.",              startAt: 155, endAt: 225, weight: 500, emphasizedWord: "expiry",  position: 83, fontSize: 50 },
  { text: "Send it anywhere.",                      startAt: 235, endAt: 295, weight: 500, emphasizedWord: "anywhere",position: 83, fontSize: 50 },
];

export const SHARE_CAPTIONS_V2_LANDSCAPE: CaptionEntry[] = [
  { text: "One link. Self-contained.",              startAt: 0,   endAt: 75,  weight: 700, emphasizedWord: "link",    position: 90, fontSize: 81 },
  { text: "The hash never leaves the browser.",     startAt: 80,  endAt: 150, weight: 700, emphasizedWord: "hash",    position: 90, fontSize: 81 },
  { text: "No expiry. No permission required.",     startAt: 155, endAt: 225, weight: 500, emphasizedWord: "expiry",  position: 90, fontSize: 59 },
  { text: "Send it anywhere.",                      startAt: 230, endAt: 290, weight: 500, emphasizedWord: "anywhere",position: 90, fontSize: 59 },
];
