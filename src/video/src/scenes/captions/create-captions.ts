...
export const CREATE_CAPTIONS_VERTICAL: CaptionEntry[] = [
  ...
  { text: "Get a link.",         startAt: 240, endAt: 360, weight: 700, emphasizedWord: "link",    position: 16, fontSize: 72 },
];
...
export const CREATE_CAPTIONS_LANDSCAPE: CaptionEntry[] = [
  ...
  { text: "Get a link.",                       startAt: 255, endAt: 360, weight: 700, emphasizedWord: "link",           position: 16, fontSize: 81 },
];
