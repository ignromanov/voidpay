...
export const CREATE_CAPTIONS_VERTICAL: CaptionEntry[] = [
  { text: "Create an invoice.",  startAt: 0,   endAt: 70,  weight: 700, emphasizedWord: "Create", position: 45, fontSize: 72 },
  ...
  { text: "Get a link.",         startAt: 240, endAt: 360, weight: 700, emphasizedWord: "link",   position: 45, fontSize: 72 },
];

export const CREATE_CAPTIONS_LANDSCAPE: CaptionEntry[] = [
  { text: "Create an invoice.",                startAt: 0,   endAt: 80,  weight: 700, emphasizedWord: "Create",         position: 80, fontSize: 81 },
  ...
  { text: "Get a link.",                       startAt: 255, endAt: 360, weight: 700, emphasizedWord: "link",           position: 80, fontSize: 81 },
];
