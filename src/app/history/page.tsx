 ...
 *
 * Thin wrapper that loads HistoryWorkspace with ssr:false.
 * HistoryWorkspace accesses useTrackedInvoiceStore.persist (browser-only API).
 */
...
const HistoryWorkspace = dynamic(
  () => import('./HistoryWorkspace').then((m) => ({ default: m.HistoryWorkspace })),
