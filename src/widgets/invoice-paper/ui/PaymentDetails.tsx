        ...
        <div className="space-y-4 p-4">
          ...
          <div className="space-y-1">
            ...
            <div className="rounded border border-zinc-200 bg-white p-1.5 font-mono text-[10px] break-all text-zinc-900">
              <AnimatedText text={senderAddress || '0x...'} />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              ...
              <span className="block font-mono text-xs font-bold text-black">
                <AnimatedText text={currency} />
              </span>
            </div>
            <div className="space-y-1">
              <span className="block text-[10px] font-bold text-zinc-400 uppercase">
              ...
              <span className="block truncate rounded bg-zinc-100 px-1 py-0.5 font-mono text-[10px] text-zinc-600">
                <AnimatedText text={formatShortAddress(tokenAddress || '')} />
              </span>
            </div>
          </div>
            ...
            <div className="mt-2 border-t border-dashed border-zinc-300 pt-2">
              <div className="flex flex-col gap-1">
                ...
                <a
                  ...
                  className="group flex items-center justify-between rounded border border-emerald-100 bg-emerald-50 px-2 py-1 transition-colors hover:border-emerald-300"
                  title="View on Explorer"
                >
                  <span className="font-mono text-[9px] font-medium text-emerald-700">
