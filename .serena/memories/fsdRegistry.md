...
| Slice                        | Public API                                                          | Status      | SpecKit | Dependencies                              |
| ---------------------------- | ------------------------------------------------------------------- | ----------- | ------- | ----------------------------------------- |
| `widgets/landing`            | `HeroSection, HowItWorks, WhyVoidPay, DemoSection, FooterCta, AudienceSection, LandingContent, NetworkThemeProvider, useNetworkTheme` | Implemented | P0.12   | shared/ui, widgets/network-background     |
...
| --------- | ----------- | ----------- | ------- | -------------------------------------------------- |
| `/`       | LandingPage | Implemented | P0.12   | widgets/landing, widgets/network-background        |
