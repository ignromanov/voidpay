...
- [ ] T010-test [P] [US1] Unit test for [Entity1] validation in src/[path]/__tests__/[entity1].test.ts
- [ ] T011-test [P] [US1] Unit test for [Service] in src/[path]/__tests__/[service].test.ts
- [ ] T012-test [US1] Snapshot test for schema encoding in src/[path]/__tests__/[schema].test.ts
...
- [ ] T020-test [P] [US2] Unit test for [Entity] in src/[path]/__tests__/[entity].test.ts
- [ ] T021-test [P] [US2] Unit test for [Service] in src/[path]/__tests__/[service].test.ts
...
- [ ] T030-test [P] [US3] Unit test for [Entity] in src/[path]/__tests__/[entity].test.ts
- [ ] T031-test [P] [US3] Unit test for [Service] in src/[path]/__tests__/[service].test.ts
