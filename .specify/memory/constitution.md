...
- [ ] T010-test [US1] Unit test for invoice validation in __tests__/validate-invoice.test.ts
- [ ] T011-test [US1] Snapshot test for schema encoding in __tests__/invoice-schema.test.ts
