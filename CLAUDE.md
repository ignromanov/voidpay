...
> **Constitution**: `.specify/memory/constitution.md` (v1.0.0) 🔴 **READ FIRST**
...
**Core**: Next.js 14+ (App Router), TypeScript, Tailwind, shadcn/ui
**Web3**: Wagmi v2, Viem, RainbowKit v2
**RPC**: Alchemy (primary), Infura (fallback)
**State**: Zustand + persist, TanStack Query, lz-string
